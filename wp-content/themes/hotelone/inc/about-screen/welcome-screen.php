			...
			<?php if ( $tab == 'demo-data-importer' ) { ?>
				<div class="demo-import-tab-content info-tab-content">
					...
					<?php if ( class_exists('OCDI_Plugin') ) {?>
						...
						<?php printf(sprintf(__( '<p>Congratulations! you installed importer plugin successfully. Click Here to start <a href="%s">Import Data</a></p>', 'hotelone' ),esc_url( admin_url('themes.php?page=one-click-demo-import') ))); ?>
						</div>
