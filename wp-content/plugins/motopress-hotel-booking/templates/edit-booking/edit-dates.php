...
<div class="mphb-search-form-wrapper">
    <form class="mphb-search-form" action="<?php echo esc_attr($actionUrl); ?>" method="POST">
        ...
        <p class="mphb-check-in-date">
            ...
            <br>
            <input type="text" inputmode="none" id="mphb_check_in_date" name="check_in_date" class="mphb-datepick" value="<?php echo esc_attr($checkInDate); ?>" placeholder="<?php _e('Check-in Date', 'motopress-hotel-booking'); ?>" required="required" autocomplete="off">
        </p>
        ...
        <p class="mphb-check-out-date">
            ...
            <br>
            <input type="text" inputmode="none" id="mphb_check_out_date" name="check_out_date" class="mphb-datepick" value="<?php echo esc_attr($checkOutDate); ?>" placeholder="<?php _e('Check-out Date', 'motopress-hotel-booking'); ?>" required="required" autocomplete="off">
        </p>
